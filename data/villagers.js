...
export const villagers = [
  ...
  },
  {
    id: "udo",
    name: "ウート",
    birthYearOffset: -5, // 降臨(Year 1)時に6歳。お兄さんより少し年下。
    role: "代官 (Villicus) / 小領主",
    history: [
      {
        year: 15,
        role: "徴税実務官",
        status: "困惑",
        evaluation:
          "ジギベルト（当時・小領主）に抜擢された若き代官。お兄さんの村から届く納税記録が「1mgの狂いもない」ことに恐怖を覚え、自分の算盤を疑い始める。",
        health: 90,
        social: 75,
        traits: ["帳簿好き", "胃弱"],
      },
      {
        ...
        status: "心酔",
        evaluation:
          "ジギベルトの伯爵昇進に伴い、広域の物流管理を任される。お兄さんの『標準器』を領地全体に導入する実務責任者となり、不正が不可能な「物理OS」の信奉者と化した。",
        health: 80,
        social: 88,
        traits: ["標準化の守護者", "精密計測器コレクター"],
      },
    ],
  },
  // --- 第2章・第3章の主要人物 (エルザ村) ---
  ...
  },
  {
    ...
    status: "伝統重視",
    evaluation:
      "地域領主。お兄さんの『異常な高収益』を、最初は単なる幸運（神の恩寵）と誤認するが、次第にその技術的優位性に気づき、システムの統合（婚姻）を画策する。",
    history: [
      {
        year: 23, // ローデリヒ誕生時
        health: 75,
  ...
  },
  {
    id: "lenard",
    name: "レナート",
    birthYearOffset: -15, // 降臨(Year 1)時に16歳。ウートより年上で、旧来のやり方に染まりきっている。
    role: "中央派遣徴税吏 (Exactor)",
    status: "汚職 / 旧規格固執",
    evaluation:
      "エバーハルト広域伯の威光を傘に着る、高慢な徴税官。お兄さんの『100cm・1kg』という新規格を『地方のまじない』と蔑み、自分の底上げされた枡と、磁石を仕込んだ天秤による徴収を強行しようとする。その行為は、技術による統治を目指すローデリヒにとって『帝国の基盤を損なう大罪』とみなされた。",
    history: [
      {
        year: 37, // 4章：ローデリヒ断罪時
        role: "巡回徴税官",
        health: 70,
        social: 85, // 権威に寄生しているため、表面上の社会的地位は高い
        traits: ["汚職体質", "変化への拒絶", "磁石使い"],
      },
      {
        year: 38,
        role: "追放者",
        status: "失脚",
        evaluation:
          "ローデリヒによる『公開較正試験』にて、自身の計量器の不正を物理的に証明され、全財産没収の上で追放。彼の没落は、領地全体に『お兄さん規格』の法的絶対知らしめる見せしめとなった。",
        health: 40,
        social: 0,
        traits: ["破滅", "規格外の男"],
      },
